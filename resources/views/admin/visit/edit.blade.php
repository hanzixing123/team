...
<br><br><br>
<form class="form-horizontal" action="{{'/visit/update/'.$res->vis_id}}" method="post"   role="form">
		  @csrf
	<div class="form-group">
		...
		<div class="col-sm-5">
				<select name="cust_id"class="form-control" id="firstname">
					...
					@foreach($Custom as $v)
					<option value="{{$v->cust_id}}"@if($v->cust_id==$res->cust_id) selected @endif>{{$v->cust_name}}</option>
					@endforeach
				</select>
	...
	<div class="form-group">
		...
		<div class="col-sm-5">
			<input type="text" class="form-control"name="vis_name" value="{{$res->vis_name}}" id="firstname" 
				   placeholder="请输入访问人">
	...
	<div class="form-group">
		...
		<div class="col-sm-5">
			<input type="text" class="form-control"name="vis_url" value="{{$res->vis_url}}" id="firstname" 
				   placeholder="请输入访问地址">
...
<div class="form-group">
		...
		<div class="col-sm-5">	
			<textarea name="vis_desc"class="form-control" id="firstname">{{$res->vis_desc}}</textarea>
